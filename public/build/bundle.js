...
var app = (function () {
    ...
    /* components/Nav.svelte generated by Svelte v3.59.2 */
    const file$1 = "components/Nav.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			a.textContent = "Home";
    			attr_dev(div, "class", "brand svelte-j40c2l");
    			add_location(div, file$1, 34, 4, 666);
    			attr_dev(a, "href", "/");
    			attr_dev(a, "class", "nav-link svelte-j40c2l");
    			add_location(a, file$1, 37, 4, 747);
    			attr_dev(nav, "class", "svelte-j40c2l");
    			add_location(nav, file$1, 32, 2, 620);
    		},
    ...
    // (55:3) {#each snips as { id, name, content }}
    function create_each_block(ctx) {
    	...
    	function input_input_handler() {
    		/*input_input_handler*/ ctx[1].call(input, /*each_value*/ ctx[5], /*each_index*/ ctx[6]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			attr_dev(a, "href", a_href_value = `edit.html?id=${/*id*/ ctx[2]}`);
    			add_location(a, file, 57, 4, 1234);
    			attr_dev(input, "class", "copy-input svelte-1077dzm");
    			add_location(input, file, 60, 4, 1340);
    			add_location(button, file, 61, 4, 1394);
    			attr_dev(div, "class", "snip-container svelte-1077dzm");
    			add_location(div, file, 55, 2, 1166);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*content*/ ctx[4]);
    			append_dev(div, t2);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*snips*/ 1 && t0_value !== (t0_value = /*name*/ ctx[3] + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*snips*/ 1 && a_href_value !== (a_href_value = `edit.html?id=${/*id*/ ctx[2]}`)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if (dirty & /*snips*/ 1 && input.value !== /*content*/ ctx[4]) {
    				set_input_value(input, /*content*/ ctx[4]);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:3) {#each snips as { id, name, content }}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 51, 3, 1064);
    			attr_dev(div0, "class", "container svelte-1077dzm");
    			add_location(div0, file, 50, 1, 1037);
    			add_location(div1, file, 45, 2, 932);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function input_input_handler(each_value, each_index) {
    		each_value[each_index].content = this.value;
    		$$invalidate(0, snips);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('snips' in $$props) $$invalidate(0, snips = $$props.snips);
    	};
    	...
    	return [snips, input_input_handler];
    }
